...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(507, 327)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(MainWindow.sizePolicy().hasHeightForWidth())
        MainWindow.setSizePolicy(sizePolicy)
        MainWindow.setMaximumSize(QtCore.QSize(507, 327))
        ...
        MainWindow.setTabOrder(self.spinBox_b, self.pushButton_write)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "Province Set-Upper"))
        self.pushButton_load.setToolTip(_translate("MainWindow", "<html><head/><body><p>Load the .csv file.</p></body></html>"))
        ...
        self.lineEdit_religion.setToolTip(_translate("MainWindow", "<html><head/><body><p>The default religion of all provinces</p></body></html>"))
        ...
        self.checkBox_isTribal.setToolTip(_translate("MainWindow", "<html><head/><body><p>Check if the county capital is tribal. Leave be for Castle/City/Temple set-up.</p></body></html>"))
        self.checkBox_isTribal.setText(_translate("MainWindow", "Is Tribal"))
        self.label_4.setText(_translate("MainWindow", "Terrain:"))
        self.lineEdi_terrain.setToolTip(_translate("MainWindow", "<html><head/><body><p>The terrain of the province</p></body></html>"))
        self.lineEdi_terrain.setPlaceholderText(_translate("MainWindow", "Plains"))
        self.label_3.setToolTip(_translate("MainWindow", "<html><head/><body><p>The RGB base for the provinces. Each province will slightly deviate from this, creating different hues of this base colour.</p></body></html>"))
        self.label_3.setText(_translate("MainWindow", "RGB Base:"))
        self.pushButton_write.setToolTip(_translate("MainWindow", "<html><head/><body><p>Write the files.</p></body></html>"))

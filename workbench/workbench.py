...
for x in provinces:
    ...
    province.write.history_province(province_dict, current_id, in_culture, in_religion, in_is_tribal, in_terrain)
    province.write.history_titles(province_dict)
    province.write.province_set_up(province_dict, current_id, in_terrain)
    province.write.landed_titles(province_dict,rgb_basis)
    current_id += 1